...
public class RegisterAndForgotPassController {
	...
	public String saveClient(@ModelAttribute("Custumer") Custumer custumer, HttpServletRequest request, Model model)
	...
	public String GetPW(HttpServletRequest request, Model model)
			throws MessagingException, UnsupportedEncodingException {
